...
class AdversarialPartA2(PartA2):

    def __init__(self, adversary, **kwargs):
        super(AdversarialPartA2, self).__init__(**kwargs)
    ...
    def extract_feat(self, points, img_metas):
        ...
        return feats_dict, voxel_dict, perturbation
    ...
    def forward_train(self,
        ...
        """
        feats_dict, voxels_dict, perturbation = self.extract_feat(
            points, img_metas)
