...
class VoxelPerturber(nn.Module):
    ...
    def __init__(self):
        ...
        self.model = nn.Sequential(nn.InstanceNorm1d(4), nn.Conv1d(4, 4, 1),
                                   ...
                                   nn.Conv1d(4, 8, 1), nn.BatchNorm1d(8),
                                   nn.ReLU(), nn.Conv1d(8, 16, 1),
                                   nn.BatchNorm1d(16), nn.ReLU(),
                                   nn.Conv1d(16, 32, 1), nn.BatchNorm1d(32),
                                   nn.ReLU(), nn.Conv1d(32, 16, 1),
                                   nn.BatchNorm1d(16), nn.ReLU(),
                                   nn.Conv1d(16, 8, 1), nn.BatchNorm1d(8),
                                   nn.ReLU(), nn.Conv1d(8, 4, 1),
                                   nn.BatchNorm1d(4), nn.ReLU(),
                                   nn.Conv1d(4, 4, 1), nn.BatchNorm1d(4),
                                   nn.ReLU(), nn.Conv1d(4, 4, 1))
